# lab_coffee_utils.py  (robust imports + fallbacks)
...
# -------- Optional style file (fallback to default if missing) --------
try:
    plt.style.use('./deeplearning.mplstyle')
except OSError:
    # fallback: default style + a few cosmetic tweaks
...
# -------- Optional color dict from Coursera utils (with fallback) -----
try:
    from lab_utils_common import dlc  # provides dlblue/dldarkblue/dlpurple, etc.
except Exception:
    # minimal palette compatible with your code
    dlc = {
        "dlblue":     "#0096ff",
        "dldarkblue": "#1f77b4",
        "dlpurple":   "#6a5acd",
...
def plt_prob(ax, fwb):
    """plots decision boundary with probability shading"""
